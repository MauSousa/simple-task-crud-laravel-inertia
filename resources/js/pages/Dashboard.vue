...
import { Head, WhenVisible, router, useForm } from '@inertiajs/vue3';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div class="grid auto-rows-min gap-4 md:grid-cols-2">
                                ...
                                <SheetDescription>
                                    ...
                                    <form @submit.prevent="submit" class="mt-3 space-y-4">
                                        ...
                                        <div class="grid gap-2">
                                            ...
                                            <Textarea id="desc" placeholder="Type description" :tabindex="2" v-model="form.description" />
                ...
                <div class="relative aspect-video h-20 w-full overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border">
                    ...
                    <Table>
                        ...
                        <TableBody>
                            <TableRow v-for="(task, index) in tasks" :key="task.id">
                                ...
                                <TableCell class="flex items-center justify-end space-x-5">
                                    <Button v-if="!task.is_completed" variant="secondary" @click="completeTask(task.id)">Complete</Button>
